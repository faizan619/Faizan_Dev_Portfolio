export default function FormContact(){
    return(
            ...
            <div className="">
                ...
                <form novalidate="" className="">
                    <label className="">
                        ...
                        <input type="text" placeholder="Leroy Jenkins" className="" />
                    </label>
                    <label className="block">
                        <span className="mb-1">Email address</span>
                        <input type="email" placeholder="leroy@jenkins.com" className="" />
                    </label>
                    <label className="block">
        ...
        // <section className="py-6 dark:bg-gray-800 dark:text-gray-50 border h-screen ">
