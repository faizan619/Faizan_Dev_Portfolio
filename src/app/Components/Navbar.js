...
export default function Navbar() {
  return (
    <nav className="flex items-center justify-between p-5 bg-[#022f69] text-white sticky top-0 z-10">
      ...
      <ul className="nav-links">
        ...
        <div className="flex text-center bg-gray-800 gap-4 text-lg menu md:bg-[#022f69] ">
