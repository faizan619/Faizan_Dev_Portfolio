    ...
    return(
        <div className="flex flex-col  items-center px-1 bg-white text-[#01003d]">
            <div className="flex flex-col items-center ">
                <h1 className="text-4xl font-semibold m-2 pt-5">Projects</h1>
                <p className="text-gray-800 text-lg xl:w-[40rem] text-center m-2">Here you will find some of the project that i have created. Each Project containing its source code and live preview</p>
            </div>
                    ...
                    <div key={item.id} className="flex flex-col items-center lg:flex-row ">
                        ...
                        <div className="lg:w-[40%] p-4  flex items-center ">
                            <div className="flex flex-col gap-4  px-3 ">
                                ...
                                <p className="text-gray-800 text-lg">{item.projinfo}</p>
                                <div className="my-5 flex justify-center gap-5 sm:gap-10 text-sm ">
                                    <Link className="border px-1 sm:px-3 xl:px-10 rounded-xl hover:cursor-alias text-white bg-[#01003d] py-3" target="_blank" href={item.source}>Source Code</Link>
                                    <Link className="border border-[#01003d] px-1 sm:px-3 xl:px-10 rounded-xl  py-3 cursor-alias" target="_blank" href={item.live}>Live Preview</Link>
                                </div>
                            </div>
                        </div>
                    </div>
