        ...
        <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                <div className="py-6 md:py-0 md:px-6 flex flex-col justify-center">
                    ...
                    <p className="pt-2 pb-4 text-gray-400 text-lg">Fill in the form to start a conversation</p>
                ...
                <form novalidate="" className="flex flex-col space-y-7 md:py-5 md:px-6 ">
                    ...
                    <label className="block">
                        ...
                        <input type="email" placeholder="leroy@jenkins.com" className="block px-3 py-2 border w-full rounded-md shadow-sm focus:ring focus:ri focus:ri dark:bg-gray-800" />
                    </label>
                    <label className="block">
